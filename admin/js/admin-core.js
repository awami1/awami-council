...
const COMMITTEES_DATA = [
  {id:'c1',name:'لجنة العمرة الرجبية',icon:'🕋',color:'linear-gradient(135deg,#1a6b3c,#2d9955)',desc:'تنظيم رحلة العمرة السنوية في شهر رجب'},
  {id:'c2',name:'لجنة غداء العيدين',icon:'🍖',color:'linear-gradient(135deg,#c8a84b,#e8c96a)',desc:'تنظيم وإدارة غداء عيد الفطر وعيد الأضحى'},
  {id:'c3',name:'لجنة المسابقة الرمضانية',icon:'🌙',color:'linear-gradient(135deg,#1a3a6b,#2d5ab9)',desc:'إعداد وتحكيم المسابقات الرمضانية'},
  {id:'c4',name:'لجنة الرحلات',icon:'🎡',color:'linear-gradient(135deg,#2980b9,#5dade2)',desc:'تخطيط وتنفيذ الرحلات الترفيهية للعائلة'},
  {id:'c5',name:'لجنة ليلة القدر',icon:'✨',color:'linear-gradient(135deg,#4a235a,#8e44ad)',desc:'إحياء ليلة القدر وتنظيم فعالياتها'},
  {id:'c6',name:'لجنة تنظيف المساجد',icon:'🕌',color:'linear-gradient(135deg,#117a65,#1abc9c)',desc:'تنسيق حملات تنظيف وصيانة المساجد (العمل التطوعي)'},
  {id:'c7',name:'لجنة مسابقة العيد',icon:'🏆',color:'linear-gradient(135deg,#b7950b,#d4ac0d)',desc:'تنظيم مسابقات وفعاليات العيد'},
  {id:'c8',name:'لجنة الاستثمار',icon:'📈',color:'linear-gradient(135deg,#1B3456,#2d5a85)',desc:'إدارة واستثمار أموال الصندوق'},
  {id:'c9',name:'اللجنة الاستشارية',icon:'🎓',color:'linear-gradient(135deg,#4a235a,#7b2d8b)',desc:'تقديم المشورة والتوجيه لإدارة المجلس',advisory:true},
  {id:'c10',name:'اللجنة الإعلامية',icon:'📢',color:'linear-gradient(135deg,#c0392b,#e74c3c)',desc:'إدارة المنصات الإعلامية وتوثيق الفعاليات'},
  {id:'c11',name:'لجنة العقيقة الجماعية',icon:'🐑',color:'linear-gradient(135deg,#6b3a1a,#9b5a2d)',desc:'تنظيم مناسبات العقيقة الجماعية للعائلة'},
];
